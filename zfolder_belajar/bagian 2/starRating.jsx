...
function CustomRating(){
  ...
  return (
    <div>
      <StarRating maxRating={5} color={"blue"} size={32} defaultRating={rating} onSetRating={setRating} />
    </div>
  )
}
...
function StarRating({maxRating = 5, color = "#fcc419", size = 40, messages = [], className = "", defaultRating = 0, onSetRating }) {
...
export default function App() {
  return (
    <>
      ...
      <StarRating maxRating={10} color="green" size={32} messages={["Terrible", "Bad", "Okay", "Good", "Excellent"]} />
      <CustomRating />
    </>
  );
}
